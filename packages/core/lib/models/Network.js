...
export default class Network {
    constructor(_name = '', _protocol = 'https', _host = '', _port = 0, blockchain = null, chainId = '', _path = ''){
	...
	accounts(unique = false){
		const accounts = StoreService.get().state.scatter.keychain.accounts.filter(x => x.networkUnique === this.unique());
